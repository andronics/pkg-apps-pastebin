...
All notable changes to @apps/pastebin will be documented in this file.
...
- Declared external command requirements: curl
...
- Package naming now includes collection scope: `@apps/pastebin`
