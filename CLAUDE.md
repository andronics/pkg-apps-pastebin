# pastebin - AI Assistant Instructions

**Package**: `@apps/pastebin`
**Version**: 0.1.0
**Type**: apps package

## Package Overview

**Description**: Pastebin Client - Code and text sharing utility

**Purpose**: Provide pastebin client - code and text sharing utility functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/pastebin` - Main executable
- `.local/bin/pastebin.phase4.backup` - Main executable
...
1. **Test installation**: `stow pastebin`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D pastebin`
